...
@Service
public class UpdatableBCryptSerivce {
    private static final Logger log = LoggerFactory.getLogger(UpdatableBCryptSerivce.class);

    private final int logRounds;

    public UpdatableBCryptSerivce(@Value("${security.salt.rounds}") int logRounds) {
